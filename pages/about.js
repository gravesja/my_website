  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12">
      <div className="max-w-6xl mx-auto px-6"> {/*width */}
        ...
        <section id="skills" class="py-12 bg-gray-100">
  <div class="container mx-auto px-6">
    ...
    <div class="grid md:grid-cols-3 gap-6">
      ...
      <div class="bg-blue-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-network-wired"></i> Networking</h3>
        <div class="grid gap-2">
          <div class="skill-item">PowerShell</div>
          <div class="skill-item">Wireshark</div>
          <div class="skill-item">PuTTY</div>
          <div class="skill-item">VLAN/LAN/WAN</div>
          <div class="skill-item">DHCP, ARP, NAT</div>
        </div>
      </div>

      
      <div class="bg-red-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-shield-alt"></i> Cybersecurity</h3>
        <div class="grid gap-2">
          <div class="skill-item">IPS/IDS</div>
          <div class="skill-item">EDR</div>
          <div class="skill-item">Fortinet</div>
          <div class="skill-item">pfSense</div>
          <div class="skill-item">Ubiquiti Cloud Gateway</div>
        </div>
      </div>

     
      <div class="bg-green-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-cloud"></i> Cloud</h3>
        <div class="grid gap-2">
          <div class="skill-item">Azure</div>
          <div class="skill-item">AWS</div>
          <div class="skill-item">WatchGuard Cloud</div>
        </div>
      </div>

      
      <div class="bg-purple-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-microchip"></i> Hardware</h3>
        <div class="grid gap-2">
          <div class="skill-item">Routers</div>
          <div class="skill-item">Access Points</div>
          <div class="skill-item">Fiber</div>
          <div class="skill-item">Coaxial</div>
        </div>
      </div>

      <div class="bg-yellow-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-laptop"></i> IT</h3>
        <div class="grid gap-2">
          <div class="skill-item">Windows</div>
          <div class="skill-item">Mac</div>
          <div class="skill-item">iOS</div>
          <div class="skill-item">Office 365</div>
        </div>
      </div>

      
      <div class="bg-teal-500 text-white p-6 rounded-2xl shadow-lg">
        <h3 class="text-xl font-semibold mb-4"><i class="fas fa-code"></i> Coding</h3>
        <div class="grid gap-2">
